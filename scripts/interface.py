...
def main_menu():
    while True:
        os.system('clear')
        print_title("Ubuntu 24 - Tweaks and Installer")
        print("\n\n")
...
def system_installation_menu():
    while True:
        os.system('clear')
        print_title("Ubuntu24-TweakInstall - System Install and Updates")
...
def software_management_menu():
    while True:
        os.system('clear')
        print_title("Ubuntu24-TweakInstall - Software and Packages")
...
def hardware_optimization_menu():
    while True:
        os.system('clear')
        print_title("Ubuntu24-TweakInstall - Hardware and Drivers")
        print("    1. CPU Setup\n\n"
              "    2. GPU Setup\n\n")
        thin_separator()
...
def cpu_setup_menu():
    while True:
        os.system('clear')
        print_title("Ubuntu24-TweakInstall - Processor Setup")
        print("    1. AMD CPU\n\n"
              "    2. Intel CPU\n\n")
        thin_separator()
        print("Selection; Menu Options 1-2, Back To Main = B: ", end="")
...
def gpu_setup_menu():
    while True:
        os.system('clear')
        print_title("Ubuntu24-TweakInstall - Graphics Setup")
...
def system_tweaks_menu():
    while True:
        os.system('clear')
        print_title("Ubuntu24-TweakInstall - Tweaks and Hacks")
...
def user_folder_menu():
    while True:
        os.system('clear')
        print_title("Ubuntu24-TweakInstall - Common Folders")
