...
- First thing I noticed after going through the processes, is that the sound was working on my Usb SoundCard (Sound through the GPUs is more complicated setup), so while setting up/install of larger programs, is best done while skimming informative videos relevant to subject/further software being installed. 
