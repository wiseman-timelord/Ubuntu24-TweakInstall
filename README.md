...
### Notation:
- Why 24.10? Its because 24.04 would not install, even in any of its decimal variants, to my nvme that runs at 6000MB/s, so was <_< time waster, however, I was able to install just fine on 24.10.x beta, and, 22.x and 20.x, installs fine, and I am now at the time of writing on `22.x`, but with the KVM hijacking the only sound output I can get to work without breaking the graphics drivers, if this carrys on I'm going back to windows. 
